\documentclass{ankit_cv}

\setname{Ankit Varma}{}
\setaddress{Seawoods, Navi Mumbai}
\setmobile{+91 81692 35673}
\setmail{send2ankit@ya.ru}
\setposition{Work Student} %ignored for now
\setlinkedinaccount{https://www.linkedin.com/in/retroankit/} %you can play with color of the template (red is also nice..)
\setgithubaccount{https://github.com/Ankit-Varma} %you can play with color of the template (red is also nice..)
